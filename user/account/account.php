...
<div  class="container">
    <div style="border-radius: 5px; border: 1px solid rosybrown;">
        <h1 class="text-center text-3xl py-9">Thông tin tài khoản</h1>
        <form class="sm:px-9 input_form">
            <label class="font-bold">Họ Tên</label>
            <input class="w-full my-2 p-1" type="text" name="name" value="<?php echo $rs->name ?>" placeholder="Họ và tên" disabled>
            <label class="font-bold">Email</label>
            <input class="w-full my-2 p-1" type="email" name="email" value="<?php echo $rs->email ?>" placeholder="Email" disabled>
            <label class="font-bold">Số điện thoại</label>
            <input class="w-full my-2 p-1" type="text" name="phone" value="<?php echo $rs->phone ?>" placeholder="Số điện thoại" disabled>
            <label class="font-bold">Mật Khẩu</label>
            <input class="w-full my-2 p-1" type="password" name="password" value="<?php echo $rs->password ?>" placeholder="Mật khẩu" disabled>
            <div class="text-center my-9">
                <a class=" btn btn-warning center" href="edit-account.php">Chỉnh sửa thông tin</a>
            </div>
        </form>
    </div>
</div>
